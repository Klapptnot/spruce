local api = require("src.spruce.api")
...
local __map__ = {
...

  {
    ...
    mode = { "n", "v", "t" },
    exec = api.scroll_down,
    desc = "Move down cursor",
    opts = __def_opts_lua__,
  },
...

  {
    mapp = "'",
    mode = { "v" },
    exec = function() api.wrap_selection({ "'", "'" }) end,
    desc = "Wrap the visual selection with single quotes",
    opts = __def_opts_lua__,
  },

  {
    ...
    mode = { "v" },
    exec = function() api.wrap_selection({ '"', '"' }) end,
    desc = "Wrap the visual selection with double quotes",
    opts = __def_opts_lua__,
  },

  {
    ...
    mode = { "v" },
    exec = function() api.wrap_selection({ "{", "}" }) end,
    desc = "Wrap the visual selection with brackets",
    opts = __def_opts_lua__,
  },

  {
    ...
    mode = { "v" },
    exec = function() api.wrap_selection({ "(", ")" }) end,
    desc = "Wrap the visual selection with parenthesis",
    opts = __def_opts_lua__,
  },

  {
    ...
    mode = { "v" },
    exec = function() api.wrap_selection({ "`", "`" }) end,
    desc = "Wrap the visual selection with backticks",
    opts = __def_opts_lua__,
  },

  {
    ...
    mode = { "v" },
    exec = function() api.wrap_selection({ "[", "]" }) end,
    desc = "Wrap the visual selection with square brackets",
    opts = __def_opts_lua__,
  },
